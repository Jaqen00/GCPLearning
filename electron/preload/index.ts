...
const api: RecorderApi = {
  ...
  setPreferredWindowHeight: (height: number) => ipcRenderer.invoke('window:set-preferred-height', height),
  startLearning: () => ipcRenderer.invoke('learning:start'),
  pauseLearning: () => ipcRenderer.invoke('learning:pause'),
  resumeLearning: () => ipcRenderer.invoke('learning:resume'),
